...
const siteSetup = {
  ...
  siteData: {
    name: 'Sublinks Demo',
    sidebar: `# Welcome to the Sublinks Demo!

**We are currently using the Lemmy Front-end**; however, this will soon change as we work on our front-end.

Sublinks are compatible with the API of Lemmy v0.19.3. This allows Lemmy apps and front-ends to work with Sublinks.

For more information about Sublinks, visit [Sublinks.org](https://sublinks.org).`,
    description: 'Sublinks Demo!',
...
allPosts.forEach(post => {
  ...
  // Every 7th post gets no attention
  if (postId % 7 === 0) {
    return;
  }
  ...
  allUsers.forEach(user => {
    ...
    const likePost = !(postId % 2 === 0 && userId % 5 === 0);
    likes.push({
      type: 'likePost',
      creator: user,
      data: {
